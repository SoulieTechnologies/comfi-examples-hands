...
def loadModel(augmenterDir, augmenterModelName="LSTM", augmenter_model="v0.3"):
    ...
    for idx_augm, augmenterModelType in enumerate(augmenterModelType_all):
        augmenterModelDir = os.path.join(
            augmenterDir, augmenterModelName, augmenterModelType
        )
...
def augmentTRC(
    ...
    marker_indices_lower = [
        ...
        21,
        20,
    ]  # ['Neck', 'RShoulder', 'LShoulder', 'RHip', 'LHip', 'RKnee', 'LKnee', 'RAnkle', 'LAnkle', 'RHeel', 'LHeel', 'RSmallToe', 'LSmallToe', 'RBigToe', 'LBigToe']
    marker_indices_upper = [
        18,
        6,
        5,
        8,
    ...
    for augmenterModelType in augmenterModelType_all:
        ...
        for i in range(0, unnorm_outputs.shape[1], 3):
            unnorm2_outputs[:, i : i + 3] = (
                unnorm_outputs[:, i : i + 3] + referenceMarker_data
            )
